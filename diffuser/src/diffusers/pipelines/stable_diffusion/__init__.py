...
if is_transformers_available() and is_torch_available():
    ...
    from .pipeline_stable_diffusion_node import StableDiffusionNODEPipeline
    from .pipeline_stable_diffusion_node_for_training import StableDiffusionNODEPipelineForTrain
    from .pipeline_stable_diffusion_node_safe import StableDiffusionNODEPipelineSafe
